    ...
    return (
        ...
        <div className="grid grid-cols-3 gap-8">
          <div className="space-y-4">
            <Image width={500} height={500} src="/van.jpg" alt="Roadside assistance" className="w-full"/>
          ...
          <div className="space-y-4">
            <Image  width={500} height={500} src="/scooter.jpg" alt="Scooter Insurance" className="w-full"/>
          ...
          <div className="space-y-4">
            <Image  width={500} height={500} src="/riding-through-water.jpg" alt="Warranty" className="w-full"/>
